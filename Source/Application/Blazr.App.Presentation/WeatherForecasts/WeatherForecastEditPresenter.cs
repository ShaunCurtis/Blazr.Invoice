...
{
    public WeatherForecastEditPresenter(IMediator mediator, IRecordIdProvider<DmoWeatherForecast, WeatherForecastId> keyProvider, IRecordFactory<DmoWeatherForecast> newRecordProvider)
